...
<html lang="en">
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            <a class="navbar-brand mr-1" href="index.html">Xin chào <?php echo $_SESSION['admin_name'] ?></a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="/projectphp/dang-xuat.php">Log out</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/projectphp/dang-xuat.php" data-toggle="modal" data-target="#logoutModal"></a>
                    </div>
                </li>
            </ul>
        </nav>
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item <?php echo isset($open) && $open == 'catagory' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?php echo modules("catagory") ?>">
