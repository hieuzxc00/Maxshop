<?php 
	...
	$sql = "SELECT * FROM product WHERE catagory_id = $id";
    ...
    <br>
        ...
        <div class="col-md-10">
            ...
            <section class="box-main1">
                <h3 class="title-main"><a href=""><?php echo $EditCatagory['name'] ?></a> </h3>
                
                <div class="showitem clearfix">
                	<?php foreach ($product as $item): ?>
                	<div class="col-md-3  item-product">
	                    <a href="chi-tiet-san-pham.php?id=<?php echo $item['id'] ?>">
	                       <img src="<?php echo uploads() ?>product/<?php echo $item['thunbar'] ?>" class="" width="100%" height="250">
	                   </a>
	                   <div class="info-item">
