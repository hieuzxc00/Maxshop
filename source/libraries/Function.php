<?php
     ...
     function _debug($data){
     	...
     	$_debug = array_shift($debug_backtrace);
     ...
     function to_slug($str){
     	...
     	$str = preg_replace('/(à|á|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ|ẳ|ặ|ẵ)/', 'a' , $str);
     ...
     if(! function_exists('xss_clean')){
     	function xss_clean($data)
     	{
            ...
            //Remove javascript: and vbscript: protocols
     		...
     		$data = preg_replace('#([a-z]*)[\x00-\x20]*=([\'"]*)[\x00-\x20]*v[\x00-\x20]*b[\x00-\x20]*s[\x00-\x20]*c[\x00-\x20]*r[\x00-\x20]*i[\x00-\x20]*p[\x00-\x20]*t[\x00-\x20]*:#iu', '$1=$2nojavascript...', $data);
     		...
     		//Remove namespaced elements (we do need them)
     ...
     function base_url()
     {
     	return $url = "http://localhost:8000/projectphp/";
     }
